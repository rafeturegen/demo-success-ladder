    ...
    return (
        <>
            <section className="max-w-7xl mx-auto p-8 flex flex-col justify-center items-center gap-8">
                ...
                {userProgress.length >= 2 & userProgress.length !== 4 && <div>
                ...
                {userProgress.length >= 3 & userProgress.length !== 4 && <div>
                ...
                <div className="flex justify-center max-w-7xl flex-wrap gap-16 items-center">
                    {classPath && classPath.path.map(p => (
                            <div key={p.unit} className="text-white font-brico text-center w-72 h-36 border-2 border-slate-200 rounded-md pt-3">
