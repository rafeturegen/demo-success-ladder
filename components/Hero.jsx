...
export default function Hero() {
    return (
        <>
            <main className="flex justify-between max-w-8xl mx-auto mt-12 font-brico text text-white px-8 py-5 items-center ml-32 mr-4">
                <div className="flex flex-col gap-8">
                    ...
                    <p className="text-lg max-w-lg text-slate-100 mt-6">A right path to your Academic Success. Start your Academic Comeback today using Success Ladder.</p>
